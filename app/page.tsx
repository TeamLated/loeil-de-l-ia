    ...
    <main className="home">
        ...
        <div className="cards">
          ...
          <div ref={(el) => el && (cardsRef.current[0] = el)} className="card purple">
            ...
            <p>
              ...
              la place de l’humain dans la création artistique. Nous croyons fermement que l’art ne saurait être réduit à une simple 
              imitation esthétique : il est le reflet d’émotions, de vécus, de réflexions critiques que seule l'expérience humaine peut insuffler. 
              Ensemble, nous avons construit ce projet pour sensibiliser le public à la richesse unique de la création humaine, et pour inviter 
              chacun à s’interroger sur ce qui différencie une œuvre née d'une main humaine de celle produite par un algorithme.
            </p>
          </div>
          ...
          <div ref={(el) => el && (cardsRef.current[1] = el)} className="card green">
            ...
            <p>
              ...
              Face à cette révolution, un défi majeur se pose : serons-nous encore capables de reconnaître et de valoriser 
              l’empreinte unique de la main humaine ? Ce jeu d'observation n'est pas qu'un simple divertissement : 
              il invite chacun à s'interroger sur les critères qui rendent une œuvre profondément humaine.
            </p>
          </div>
      ...
      <style jsx>{`
        html, body {
          margin: 0;
          padding: 0;
          background: #6b21a8; /* violet sombre */
          color: white;
